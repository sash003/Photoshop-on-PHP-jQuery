...
$_SESSION['phpversion'] = substr(phpversion(), 0, strpos(phpversion(), '.', 3));
$_SESSION['img'] = array();
$_SESSION['cropimg'] = array();
$_SESSION['textimg'] = array();
$_SESSION['tmp'] = array();
...
shuffle($scan);
$scanImg = $scan[0];
echo '<h1>PHP '.$_SESSION['phpversion'].'</h1>';
?>
  ...
  <head>
    ...
    <link rel="shortcut icon" href="img/1441376757.gif" type="image/x-icon" />
    <title>Magick Photoshop</title>
...
*/<br>
          ...
          <table>
            <tr>
              ...
              <td style="position: relative;">
                <div id="goodInp" style="position: absolute;z-index: 2;text-align: center; color: #fff;background:#769c75; height:100%; font-size: 18px; padding: 0px; border: 2px solid white; border-radius: 5px;width: 258px; margin-left: 33px; bottom: 0px;">Image</div>
                <input type='file' name='image' style="position: absolute; z-index: 3;width: 258px; opacity: 0;cursor: pointer; height:100%; bottom: 0;" />
              </td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              <td>Ширина</td>
              <td><input type="text" maxlength='4' name="width" value="555" /></td>
            </tr>
            <tr>
              <td> Высота</td>
              <td><input type="text" maxlength='3' name="height" value="" /></td>
            </tr>
            <tr>
              <td>Резка по центру, любая цифра</td>
              <td><input type="text" maxlength='1' name="rlc" value="" /></td>
            </tr>
            <tr>
              <td>Сделать рамку, размеры рамки, max 100</td>
              <td><input type="text" maxlength='3' name="size_bord" value="" /></td>
            </tr>
            <tr>
              <td>Цвет рамки, по умолчанию чёрный</td>
              <td><input type="text" maxlength='7' name="color_bord" value="#000000" /></td>
            </tr>
            <tr>
              <td>Изменить яркость, от -100 до 100</td>
              <td><input type="text" maxlength='4' name="brightness" value="" /></td>
            </tr>
            <tr>
              <td>Изменить контраст, от -100 до 100</td>
              <td><input type="text" maxlength='4' name="contrast" value="" /></td>
            </tr>
            <tr>
              <td>Изменить скорость гифки, 1/100c</td>
              <td><input type="text" maxlength='3' name="speed" value="" /></td>
            </tr>
            <tr>
              <td>Поднять количество кадров в гифке</td>
              <td><input type="text" maxlength='1' name="countFrames" value="" /><span style="text-decoration: line-through; color: green; padding-left: 11px;">EXEC</span></td>
            </tr>
            <tr>
              <td>Установить количество кадров в гифке</td>
              <td><input type="text" maxlength='3' name="setCountFrames" value="" /> </td>
            </tr>
            <tr>
              <td>Замедлить гифку (float)</td>
              <td><input type="text" maxlength='3' name="setSlowdown" value="" /></td>
            </tr>
            <tr>
              <td>Убрать фон (%)</td>
              <td><input type="text" maxlength='3' name="trimBackground" value="" /> <span style="text-decoration: line-through; color: green; padding-left: 11px;">EXEC</span></td>
            </tr>
            <tr>
        ...
        <option>IMG_FILTER_EMBOSS</option>
              ...
              <td><input type="text" maxlength='2' name="filterVal" value="" /></td>
            </tr>
            <tr>
              <td>Выбрать формат</td>
              <td style="position: relative">
                <div style="position: absolute" id="format">
                  <img data-format="gif" src="img/gif.png" alt="" />
                  <img data-format="jpg" src="img/jpg.png" alt="" />
                  <img data-format="png" src="img/png.png" alt="" />
                </div>
                <input type="text" maxlength='3' name="format" value="" style="text-align: right;"/>
              </td>
            </tr>
            <!---->
            ...
            <tr style="outline: 2px solid green;">
              ...
              <td class="watermark">
                <div id="forWater" style="position: relative;height: 32px;margin-top: 1px;">
                  <div id="goodInp2" style="position: absolute;z-index: 2;text-align: center; color: #fff;background:#769c75; height:30px; font-size: 18px; padding: 0px; border: 2px solid white; border-radius: 5px;width: 258px; margin-left: 33px; bottom: 1px; line-height: 150%;">Watermark</div>
                  <input type='file' name='watermark' style="position: absolute; z-index: 3;width: 258px; opacity: 0;cursor: pointer; height:100%; bottom: 0;" />
                  <img id="clearWater" src="img/1.png" alt="" style="position: absolute; right: -72px;bottom: 1px; cursor: pointer;"/>
                </div>
                <input type="text" maxlength='3' name="coeff" value="15" /> Процент от ширины основной<br>
                <input type="text" maxlength='5' name="x" /> x координата<br>
                <input type="text" maxlength='5' name="y" /> y координата<br>
                <input type="text" maxlength='3' name="opacity" value="" /> Прозрачность (float)<br>
              </td>
            </tr>

            <!---->
            <tr>
              <td><br><input type='submit' id='buttupload' value='Вперёд!' style="background: #359216; border: 5px solid blue; border-radius: 11px; margin-left: 55px; cursor: pointer;" /></td>
              <td></td>
            </tr>
          </table>
        </form>
      ...
      <br style="clear:both;" />
      <div class="rrr" style="background: white; height:50px; display: none;">
        <div class="r" style="background: red; width: 100px;height: 50px;"></div>
      </div>
      <script>
          ...
          <form id="textEdit" style="margin: auto; width: 870px; float: left;">
            ...
            <table>
              ...
              <tr>
                ...
                <td style="width: 700px;">
                  <input type="text" maxlength="3" id="sizeInp" style="margin-left: 0; width: 111px;" />
    ...
    <script src="scripts/FormData_polyfill.js"></script>
